...
Laadi alla andmestik [*riigikogu_xii.csv*](../data/riigikogu_xii.csv) ja loe töökeskkonda. (Näpunäide: Et R ei muudaks tunnuseid faktortunnusteks, on abiks argument `as.is = TRUE`.)
