...
* Käsuga `facet_wrap` tükkideks jagatud joonistel on võimalik lubada erinevatele tükkidele erineva ulatusega skaalasid. Selleks uuri [näiteid](http://docs.ggplot2.org/current/facet_wrap.html).
